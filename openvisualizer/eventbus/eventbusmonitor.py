        ...
        if self.wiresharkDebugEnabled:
            ...
            if self.sim_mode:
                ...
                if signal == 'fromMote.data':
                    ...
                    zep = self._wrapMacAndZep(previousHop=previousHop, nextHop=self.dagoot_eui64, lowpan=lowpan)
                    self._dispatchMeshDebugPacket(zep)
                ...
                if signal == 'bytesToMesh':
                    ...
                    zep = self._wrapMacAndZep(previousHop=self.dagoot_eui64, nextHop=nextHop, lowpan=lowpan)
                    self._dispatchMeshDebugPacket(zep)
