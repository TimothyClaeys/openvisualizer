...
class OpenTunLinux(OpenTun):
    ...
    def _create_tun_if(self):
        ...
        try:
            ...
            # =====
            log.info("configuring the IPv6 address")
            ...
            # =====
            log.info("adding a static route route")
            ...
            log.info(os.popen('ip addr show ' + ifname))
            ...
            log.warning('WARNING: could not created tun interface. Are you root? ({0})'.format(err))
            return_val = None
